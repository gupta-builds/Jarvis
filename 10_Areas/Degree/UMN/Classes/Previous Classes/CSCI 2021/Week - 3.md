...
tags:
  ...
  - "#Lab"
  - "#Homework"
next: "[[10_Areas/Degree/UMN/Classes/Previous Classes/CSCI 2021/Week - 4|Week - 4]]"
---
...
- **Bit-level and Logical Operations in C:** C provides operators to manipulate data at the bit level. [[10_Areas/Degree/UMN/Classes/Previous Classes/CSCI 2021/Week - 4#Bitwise Operations in C|Bit and Logical Operations]]
	...
	- `<<` (Left Shift) and `>>` (Right Shift). A left shift `x << k` is like multiplying `x` by 2<sup>k</sup>. A right shift has two forms: [[10_Areas/Degree/UMN/Classes/Previous Classes/CSCI 2021/Week - 4#Bit shifting|Bit Shift]]
