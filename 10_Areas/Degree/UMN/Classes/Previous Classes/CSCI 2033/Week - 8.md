...
tags:
  - "#class"
next: "[[10_Areas/Degree/UMN/Classes/Previous Classes/CSCI 2033/Week - 9|Week - 9]]"
---
...
The QR factorization (A=QR) is the matrix representation of the [[10_Areas/Degree/UMN/Classes/Previous Classes/CSCI 2033/Week - 5#5.4 Gram–Schmidt algorithm|Gram-Schmidt algorithm (from Chapter 5)]]. It is a method of decomposing a matrix A (size m×n, assuming linearly independent columns) into a product of two matrices. Core Formula and Components $$A=QR$$
...
4. [[10_Areas/Degree/UMN/Classes/Previous Classes/CSCI 2033/Week - 9#Householder reflector|Continuing Householder reflector]]
## #Quiz Quiz - 6
