...
- [[Graph Algorithms#Core Ideas (Lecture)|Graph Algorithms - advanced lecture notes]] and [[Minimum Spanning Trees#Core Ideas (Lecture)|Minimum Spanning Trees - lecture notes]]: connect DFS finishing times to topological sort and SCC, and connect cut/light-edge reasoning to Kruskal and Prim.
- [[Graph Algorithms#Canonical Examples (Max 5)|Graph Algorithms - Canonical Examples]] and [[Minimum Spanning Trees#Canonical Examples (Max 5)|Minimum Spanning Trees - Canonical Examples]]: trace DAG ordering, reverse-graph SCC discovery, Kruskal component merging, and Prim heap updates.
...
- [[Graph Algorithms#Topological Sort + SCC|Graph Algorithms - Topological Sort + SCC]]
