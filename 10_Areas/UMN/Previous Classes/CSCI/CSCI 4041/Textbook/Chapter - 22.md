...
tags:
  - "#class"
  - "#Textbook"
next: "[[10_Areas/UMN/Previous Classes/CSCI/CSCI 2041/Week - 13|Week - 13]]"
---
...
## Lecture Emphasis
The professor's lecture ([[10_Areas/UMN/Previous Classes/CSCI/CSCI 2041/Week - 13|Week - 13]]) focuses on Bellman-Ford and Dijkstra, skipping Section 22.2 (DAG shortest paths) and Section 22.4 (difference constraints). The key code artifacts are in `Ch22_Single-Source_Shortest_Path.ipynb`:
