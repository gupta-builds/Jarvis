...
## Lecture Emphasis
The professor's lecture ([[10_Areas/UMN/Previous Classes/CSCI/CSCI 2041/Week - 13|Week - 13]]) covers Sections 23.1 and 23.2 but skips Johnson's algorithm (Section 23.3). The key code artifacts are in `Ch23_All-Pairs_Shortest_Path.ipynb`:
