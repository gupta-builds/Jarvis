...
- **Scope:** Determining which industries the company will compete in.
- **Organizational Design:** Determining how the resources of the firm will be coordinated across different units.
- **Ownership:** Determining the relationship between business units—specifically whether the firm should fully own (acquire) them or align through partnerships and alliances.
...
The History of Portfolio Planning: The BCG Matrix

In the 1970s, the Boston Consulting Group introduced the **Growth-Share Matrix** to help managers assess their business portfolios based on **market growth rate** and **relative market share**.

- **Stars:** High growth rate and high market share. These require significant cash investment to maintain their position until growth slows.
- **Cash Cows:** Low growth rate but high market share. These generate steady cash that can be used to fund other areas.
- **Question Marks:** High growth rate but low market share. Managers must decide whether to invest heavily to make them Stars or let them go.
- **Dogs:** Low growth rate and low market share. These are typically candidates for **divestiture** (selling off).

Why Firms Diversify

Managers seek diversification for several reasons:

- **Synergy:** Creating sustainable cost savings by combining duplicate activities or deploying underutilized assets across multiple businesses.
- **Growth and Risk Management:** Opening new opportunities for expansion and minimizing the risk of being dependent on a single industry.
...
- **Single-Product Strategy:** Focusing on one specific product in one market. This allows for deep expertise but makes the firm vulnerable to market cycles.
...
1. **Industry Attractiveness Test:** Is the industry's underlying structure favorable for high returns?.
2. **Cost of Entry Test:** Is the cost to enter the industry lower than the expected benefits?.
3. **Better-Off Test:** Will the new industry provide the firm with a competitive advantage that wouldn't exist otherwise?.
...
- **Backward Integration:** The firm owns or controls the **inputs** it uses (e.g., a candy company buying a sugar plantation).
- **Forward Integration:** The firm owns or controls the **distribution channels** or customers for its products.

Costs of Integration

Deciding to vertically integrate requires weighing two types of costs:

- **Administrative Costs:** The costs of coordinating and overseeing activities between different business units inside the firm.
- **Transaction Costs:** The costs of buying products or services from an outside supplier, including writing and managing contracts.
