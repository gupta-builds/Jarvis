...
tags:
  - "#class"
  - "#Textbook"
next: "[[10_UMN/CSCI 4041/Week - 8|Week - 8]]"
---
# Chapter 14 - Dynamic Programming
## Summary Links
- [[10_UMN/CSCI 4041/Week - 9#Chapter 14 - Dynamic Programming, Fibonacci, and Knapsack|Week - 9]]
...
Dynamic programming, like divide-and-conquer, solves problems by combining the solutions to subproblems. The word **programming** refers to a tabular method, not computer code. Unlike [[10_UMN/CSCI 4041/Concepts/Algorithms/Divide and Conquer#Definition|divide-and-conquer]], which partitions a problem into disjoint subproblems, dynamic programming is used when subproblems **overlap**. A dynamic-programming algorithm solves each subproblem exactly once and saves the result.
