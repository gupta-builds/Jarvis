...
tags:
  - "#class"
  - "#Textbook"
next: "[[10_UMN/CSCI 4041/Week - 10|Week - 10]]"
---
# Chapter - 15
Greedy algorithms are used for optimization problems. A greedy algorithm always makes the choice that looks best at the moment - a **locally optimal choice** - in the hope that this choice will lead to a **globally optimal solution**. Unlike [[Dynamic Programming|dynamic programming]], greedy algorithms do not always yield optimal solutions, but for many problems they do.
...
### Lecture Emphasis
The lecture's comparison point was greedy versus [[10_UMN/CSCI 4041/Concepts/Algorithms/Dynamic Programming#Definition|dynamic programming]].
...
## Summary Links
- [[10_UMN/CSCI 4041/Week - 10#Chapter 15 - Greedy Algorithms and Huffman Coding|Week - 10 lecture reference]]
- [[10_UMN/CSCI 4041/Concepts/Algorithms/Greedy Algorithms#Definition|Greedy Algorithms concept]]
- [[10_UMN/CSCI 4041/Concepts/Algorithms/Dynamic Programming#Definition|Dynamic Programming contrast]]
