...
- [[10_UMN/CSCI 4041/Textbook/Chapter - 20#20.1 Representations of Graphs|Chapter 20.1]], [[10_UMN/CSCI 4041/Textbook/Chapter - 20#20.2 Breadth-First Search (BFS)|Chapter 20.2]], and [[10_UMN/CSCI 4041/Textbook/Chapter - 20#20.3 Depth-First Search (DFS)|Chapter 20.3]]: explain graph representations, BFS, DFS, predecessor trees, timestamps, and `O(V+E)` runtime.
- [[10_UMN/CSCI 4041/Concepts/Graphs/Graph Algorithms#Core Ideas (Textbook)|Graph Algorithms - Core Ideas (Textbook)]], [[10_UMN/CSCI 4041/Concepts/Graphs/Graph Algorithms#Core Ideas (Lecture)|Graph Algorithms - Core Ideas (Lecture)]], and [[10_UMN/CSCI 4041/Textbook/Chapter - 20#20.1 Representations of Graphs|Chapter - 20]]: compare adjacency-list and adjacency-matrix representations and explain why the lecture code base prefers adjacency lists for traversal algorithms.
- [[10_UMN/CSCI 4041/Concepts/Graphs/Graph Algorithms#Canonical Examples (Max 5)|Graph Algorithms - Canonical Examples]]: trace BFS level discovery, DFS tree growth, timestamps, and reverse-graph construction.
- [[10_UMN/CSCI 4041/Concepts/Graphs/Graph Algorithms#Practice Map|Graph Algorithms - Practice Map]]: connect the week's content to BFS/DFS grid problems, connected components, and directed-graph reasoning.
## Key ideas (textbook)
...
- [[10_UMN/CSCI 4041/Concepts/Graphs/Graph Algorithms#Definition|Graph Algorithms]]
- [[10_UMN/CSCI 4041/Concepts/Graphs/Graph Algorithms#Core Ideas (Lecture)|Graph Algorithms - BFS and DFS]]
- [[10_UMN/CSCI 4041/Textbook/Chapter - 20#20.2 Breadth-First Search (BFS)|Chapter - 20 - BFS]]
## Lecture
