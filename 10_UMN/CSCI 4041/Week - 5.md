...
- [[10_UMN/CSCI 4041/Textbook/Chapter - 6 & 12#6.1 Heaps|Chapter - 6 heaps]], [[10_UMN/CSCI 4041/Textbook/Chapter - 6 & 12#6.3 Building a Heap|build-max-heap]], and [[10_UMN/CSCI 4041/Concepts/Algorithms/HeapSort#Proof / Reasoning Toolkit|HeapSort - Proof / Reasoning Toolkit]]: translate between tree and array indices, explain `MAX-HEAPIFY`, and prove why `BUILD-MAX-HEAP` is linear instead of $O(n \lg n)$.
- [[10_UMN/CSCI 4041/Textbook/Chapter - 6 & 12#6.5 Priority Queues|priority queues]], [[10_UMN/CSCI 4041/Concepts/Algorithms/HeapSort#Core Ideas (Lecture)|HeapSort - Core Ideas (Lecture)]], and [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Elementary Data Structures#BST Delete — 4 Cases|Elementary Data Structures - BST Delete — 4 Cases]]: compare priority queue implementations and know the standard heap operations and their coding-homework variants.
- [[10_UMN/CSCI 4041/Textbook/Chapter - 6 & 12#12.2 Querying a Binary Search Tree|BST queries]] and [[10_UMN/CSCI 4041/Textbook/Chapter - 6 & 12#12.3 Insertion and Deletion|BST deletion]]: explain successor, predecessor, transplant, and the full delete case breakdown.
- [[10_UMN/CSCI 4041/Concepts/Algorithms/HeapSort#Practice Map|HeapSort - Practice Map]] and [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Elementary Data Structures#Practice Map|Elementary Data Structures - Practice Map]]: top-k heap problems and BST validation/delete practice are still open.
...
- [[10_UMN/CSCI 4041/Concepts/Algorithms/HeapSort#Definition|HeapSort]]
...
- [[10_UMN/CSCI 4041/Textbook/Chapter - 6 & 12#12.3 Insertion and Deletion|Chapter - 6 & 12 - BST insertion and deletion]]
