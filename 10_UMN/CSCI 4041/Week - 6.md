...
tags:
  ...
  - "#class"
next:
  - "[[10_UMN/CSCI 4041/Week - 7|Week - 7]]"
---
# Entire Week
## What you must be able to do
- [[10_UMN/CSCI 4041/Textbook/Chapter - 13#13.2 Rotations|Chapter - 13 rotations]], [[10_UMN/CSCI 4041/Textbook/Chapter - 13#AVL Notes Anchored to Chapter 13|AVL notes anchored to Chapter 13]], and [[10_UMN/CSCI 4041/Concepts/Trees/AVL Trees#Core Ideas (Lecture)|AVL Trees - Core Ideas (Lecture)]]: explain why balance matters, compute balance factors, and identify LL, RR, LR, and RL repair cases.
- [[10_UMN/CSCI 4041/Textbook/Chapter - 18#18.1 Definition of B-Trees|Chapter - 18 B-tree definition]], [[10_UMN/CSCI 4041/Textbook/Chapter - 18#18.2 Basic Operations|basic operations]], and [[10_UMN/CSCI 4041/Concepts/Trees/B-Trees#Core Ideas (Lecture + Ch18_B-Tree.ipynb)|B-Trees - Core Ideas (Lecture + Ch18_B-Tree.ipynb)]]: describe B-tree nodes, minimum degree, split strategy, and why large branching factors matter for disk-based structures.
- [[10_UMN/CSCI 4041/Concepts/Trees/AVL Trees#Proof / Reasoning Toolkit|AVL Trees - Proof / Reasoning Toolkit]] and [[10_UMN/CSCI 4041/Concepts/Trees/B-Trees#Proof / Reasoning Toolkit|B-Trees - Proof / Reasoning Toolkit]]: understand the AVL height-bound recurrence and the B-tree height bound.
- [[10_UMN/CSCI 4041/Concepts/Trees/AVL Trees#Practice Map|AVL Trees - Practice Map]] and [[10_UMN/CSCI 4041/Concepts/Trees/B-Trees#Practice Map|B-Trees - Practice Map]]: rotations, height-balanced checks, and B-tree tracing are still open practice.
