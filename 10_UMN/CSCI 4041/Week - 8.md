...
- [[10_UMN/CSCI 4041/Textbook/Chapter - 11#11.2 Hash Tables|Chapter - 11 hash tables]], [[10_UMN/CSCI 4041/Textbook/Chapter - 11#11.3 Hash Functions|hash functions]], and [[10_UMN/CSCI 4041/Textbook/Chapter - 11#11.4 Open Addressing|open addressing]]: explain collisions, load factor, chaining, open addressing, and why hashing is average-case fast rather than worst-case fast.
- [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Hashing#Core Ideas (Lecture)|Hashing - Core Ideas (Lecture)]], [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Hashing#Complexity + Tradeoffs|Hashing - Complexity + Tradeoffs]], and [[10_UMN/CSCI 4041/Textbook/Chapter - 11#11.5 Practical Considerations|practical considerations]]: compare `chainhashmap`, `probehashmap`, and the CodingHW5 variants.
- [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Hashing#Proof / Reasoning Toolkit|Hashing - Proof / Reasoning Toolkit]]: use load factor and independent uniform hashing assumptions correctly in explanations.
- [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Hashing#Practice Map|Hashing - Practice Map]]: map/frequency/counting practice remains open.
...
- [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Hashing#Definition|Hashing]]
- [[10_UMN/CSCI 4041/Textbook/Chapter - 11#11.5 Practical Considerations|Chapter - 11 - practical considerations]]
- [[10_UMN/CSCI 4041/Concepts/Data Structures & Methods/Hashing#Canonical Examples (Max 5)|Hashing - Canonical Examples]]
