...
## MOC
- [[50_Archive/UMN/Classes/CSCI 4041/Week - 1 & 2#Key ideas (textbook)|Week - 1 & 2]]
- [[50_Archive/UMN/Classes/CSCI 4041/Textbook/Chapter - 1 & 2#2.2 Analyzing Algorithms|Chapter - 1 & 2 - Analyzing Algorithms]]
- [[Sorting Algorithms#Complexity + Tradeoffs|Sorting Algorithms - Complexity + Tradeoffs]]
- [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Graphs/Graph Algorithms#Complexity + Tradeoffs|Graph Algorithms - Complexity + Tradeoffs]]
...
## [[50_Archive/UMN/Classes/CSCI 4041/Textbook/Chapter - 1 & 2#Getting Started|Chapter - 1 & 2]]
### Linear Search
...
## [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Data Structures & Methods/Hashing#Complexity + Tradeoffs|Hashing]]
### Hash Tables
> [!summary] Hashing
...
## [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Algorithms/Dynamic Programming#Complexity + Tradeoffs|Dynamic Programming]]
### Dynamic Programming
...
## [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Graphs/Graph Algorithms#Complexity + Tradeoffs|Graph Algorithms]]
### Graph Traversals
> [!summary] BFS / DFS
> - BFS: $O(V + E)$
> - DFS: $O(V + E)$
...
- [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Algorithms/Dynamic Programming|Dynamic Programming]] because DP often trades exponential recursion for polynomial tables
- [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Graphs/Graph Algorithms|Graph Algorithms]] because `O(V + E)` means graph size includes both vertices and edges
- [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Data Structures & Methods/Hashing|Hashing]] because average-case and worst-case complexity can differ sharply
...
The cleanest contrast is naive Fibonacci versus memoized Fibonacci in [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Algorithms/Dynamic Programming|Dynamic Programming]].
...
- [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Algorithms/Dynamic Programming|Dynamic Programming]] - repeated subproblems and DP table complexity.
- [[Sorting Algorithms|Sorting Algorithms]] - `n log n` versus `n^2` sorting behavior.
- [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Graphs/Graph Algorithms|Graph Algorithms]] - `O(V + E)` traversal pattern.
- [[50_Archive/UMN/Classes/CSCI 4041/Concepts/Data Structures & Methods/Hashing|Hashing]] - average-case constant time versus worst-case linear time.
