...
tags:
  ...
  - "#Lab"
  - "#Homework"
next: "[[50_Archive/UMN/Classes/Previous Classes/CSCI 2021/Week - 7]]"
---
...
This is why two’s complement is preferred → uniform left shift [[50_Archive/UMN/Classes/Previous Classes/CSCI 2021/Week - 3#** Two's-Complement Encodings **| Two's Complement]]
...
```
### B & C
Compile both the files for A and compare them: Both of them are the same. [[50_Archive/UMN/Classes/Previous Classes/CSCI 2021/Week - 7#Conditional Jump Instructions| Jump Instructions]]
1. `ipow_for.c`
```bash
ipow:
