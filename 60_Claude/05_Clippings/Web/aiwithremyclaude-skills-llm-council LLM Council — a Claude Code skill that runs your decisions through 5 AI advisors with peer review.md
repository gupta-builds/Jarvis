---
title: "aiwithremy/claude-skills-llm-council: LLM Council — a Claude Code skill that runs your decisions through 5 AI advisors with peer review"
source: "https://github.com/aiwithremy/claude-skills-llm-council"
author:
published:
created: 2026-06-02
description: "LLM Council — a Claude Code skill that runs your decisions through 5 AI advisors with peer review - aiwithremy/claude-skills-llm-council"
tags:
  - "clippings"
---
## LLM Council
...
> Please install this Claude skill for me. The SKILL.md file lives in this GitHub repo: [https://github.com/aiwithremy/claude-skills-llm-council](https://github.com/aiwithremy/claude-skills-llm-council)
> 
...
1. Click [SKILL.md](https://github.com/aiwithremy/claude-skills-llm-council/blob/main/SKILL.md) at the top of this repo.
