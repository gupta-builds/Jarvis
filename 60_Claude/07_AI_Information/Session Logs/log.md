...
- Course ops pulled deadline truth from [[HIST 1103 Board]] + [[MATH 2230 Board]]: near-term = MATH add/drop Jun 5, HIST Asgmt 1–3 Jun 6, MATH WebAssign Jun 8, MATH Test 1 Jun 15, HIST Midterm Jun 18. HIST locked to admin-only (AI policy = instant fail noted). MATH framed as ML math via [[06 - ML Fundamentals (2033 + 2230)]].
...
- Per `00c - CoWork Prompt — Enhance 05 and 06`. Read via `jarvis` MCP: [[ML_Foundations]] (full), [[DSA]] (full 14-week LeetCode plan + 15 concepts), [[MATH 2230 - Calendar]], Concepts_old (15 files), 4041 Concepts subfolders, Midterm/Final Project folders, company repos in [[Repos]] + [[GitHub Stars — How Anant Uses Each Repo]].
