...
Operational agent rules live in `60_Claude/7_AI_Information`; stable plugin research and deeper workflow references live in [[40_Resources/Obsidian/Plugins/00 Plugin Reference Index]].
...
| Source-grounded summaries | `60_Claude/30_Source_Summaries/` |
| Durable AI-generated knowledge | `60_Claude/20_Distilled_Notes/` |
| Synthesized project briefs | `60_Claude/40_Project_Briefs/` |
| Durable outputs | `60_Claude/45_Outputs/` |
| Daily, weekly, monthly reviews | `60_Claude/50_Reviews/` |
| Dashboards and indexes | `60_Claude/60_Indexes/` |
| Agent/plugin operating docs | `60_Claude/7_AI_Information/` |
| Active projects and career work | `20_Progress/` |
| Active coursework | `10_UMN/` |
| Stable reference knowledge | `40_Resources/` |
| Templates and structure | `30_Order/` |
